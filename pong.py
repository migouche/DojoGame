...
class Ball(Object):
    def __init__(self, Size, Speed, Offset):
        ...
        self.size = Size
        self.Img = pygame.transform.scale(pygame.image.load("ball.png"), (self.size.x, self.size.y))
...
class Paddle(Object):
    def __init__(self, Pos, Size, Speed, Offset):
        ...
        self.pos = Pos
        self.size = Size
        self.Img = pygame.transform.scale(pygame.image.load("pala.png"), (self.size.x, self.size.y))
        self.speed = Speed
        self.rect = self.Img.get_rect()
